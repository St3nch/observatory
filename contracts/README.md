...
| `owned-telemetry-overlay-proof-v0-1.md` | ready for owner acceptance | Full M17 ephemeral overlay, alignment, discard, no-storage, no-evidence-promotion, and private-data boundary contract | Planning complete; no real private telemetry, files, persistence, canonical ingestion, reports, provider execution, database, or production integration authorized |
