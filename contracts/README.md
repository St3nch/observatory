...
| `searchclarity-proof-workflow-v0-1.md` | accepted v0.1 | Full M15 SearchClarity evidence-support, report-safe reference, claim-safety, promotion, and customer-boundary contract | Accepted by M15 ruling decision; proof implementation, customer data, overlays, report generation, production integration, provider execution, and persistence remain unauthorized |
