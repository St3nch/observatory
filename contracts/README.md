...
| `provider-cross-check-proof-v0-1.md` | ready for owner acceptance | Full M16 read-time provider disagreement, comparability, attribution, time-distance, and no-truth proof contract | Planning complete; no provider execution, purchases, recurring capture, persistence, truth/winner/composite logic, customer data, reports, or production integration authorized |
