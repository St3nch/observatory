...
- the ten approved project skills listed in `AGENTS.md` exist under `.grok/skills/`;
- `AGENTS.md` routes authority through `VISION.md`, `VOCABULARY.md`, the decision
  registers, the relevant ticket, and applicable ADRs;
- no parallel `CONTEXT.md`, `docs/agents/`, triage configuration, or local issue system
  was created.
