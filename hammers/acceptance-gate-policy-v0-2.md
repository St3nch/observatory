...
Status: accepted
Authority: database-phase acceptance policy accepted by `decisions/2026-07-13-db1-closure-and-db2-activation.md`
Milestone: accepted at DB-1 closure; governs DB-2 through DB-10
