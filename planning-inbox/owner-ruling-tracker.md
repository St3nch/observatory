...
|---|---|---|---|
| OR-A1 | Provider Cross-Check: is a *persisted* Disagreement Ledger permitted, or compute-on-read only? (V6 materialization test applies) | RG9; ROADMAP contract list; audits ISS-18; `decisions/2026-07-12-m16-provider-cross-check-contract-and-rulings.md` | ruled — compute-on-read only; no persistent ledger/cache/table without later V6 materialization proof and owner ruling |
