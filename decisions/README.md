...
| `2026-07-17-db4-r5-repeat-compatibility-review-authorization.md` | accepted decision | Authorizes a review-only repeat compatibility package against refreshed committed `ob-dev` | Review returned ready for owner execution decision; PostgreSQL execution and live-campaign acceptance remain unauthorized |
