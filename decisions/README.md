...
| `2026-07-17-db4-r2-real-spine-behavioral-proof-authorization.md` | accepted decision | Authorizes null-safe real observation admission, real evidence mint, real append-only mutation, real concurrent identity mint, and removal of three project-relation surrogate tables | R3–R5, hostile fixtures, stale-profile/test retirement, ob-dev, PostgreSQL execution, DB-5, and broader work remain unauthorized |
