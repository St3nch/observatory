...
| `2026-07-17-db4-r4-test-profile-completion-authorization.md` | accepted decision | Authorizes retirement of five stale profiles/tests, creation of six current static/contract PostgreSQL tests, and exact test/profile conformance | R5, ob-dev changes, PostgreSQL execution, DB-5, and broader work remain unauthorized |
