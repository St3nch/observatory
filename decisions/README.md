...
| `2026-07-17-db4-r3-hostile-candidate-completion-authorization.md` | accepted historical decision | Authorized completion and redesign of sixteen concrete hostile fixtures, native-versus-runner classification, existing profile SHA updates, and exact fixture-manifest enforcement | R3 completed at commit `0d41cbad560bd0609c6fdc0fbe6781ad7a3feec3`; superseded as current authority by the R4 decision |
| `2026-07-17-db4-r4-test-profile-completion-authorization.md` | accepted historical decision | Authorized retirement of five stale profiles/tests, creation of six current static/contract PostgreSQL tests, and exact test/profile conformance | R4 completed at commit `b4c02c87cbb27955245e89c2553491c1373a9435`; superseded as current authority by the R5 decision |
| `2026-07-17-db4-r5-live-campaign-gate-preparation-authorization.md` | accepted historical decision | Authorized frozen `ob-dev` compatibility review and drafting of the later owner execution gate without accepting or executing it | R5 completed at commit `3125d0817361e29caea661d753433817b852677f`; superseded as current authority by the G1–G5 compatibility-correction decision |
| `2026-07-17-db4-g1-g5-ob-dev-compatibility-correction-authorization.md` | accepted historical decision | Authorized one exact-path cross-repo correction batch for blockers G1–G5 | Corrections committed in `ob-dev` at `879529c27cad666099cf4f697eb7cbb56dec2279`; superseded as current authority by the repeat-review decision |
| `2026-07-17-db4-r5-repeat-compatibility-review-authorization.md` | accepted historical decision | Authorized a review-only repeat compatibility package against refreshed committed `ob-dev` | The later independent audit found blocking evidence-integrity defects; superseded as current authority by the post-audit correction decision |
| `2026-07-17-db4-post-audit-evidence-integrity-correction-authorization.md` | accepted decision | Authorizes the exact-path correction batch for the independent audit’s evidence-integrity blockers | Corrections committed in `ob-dev` at `e6ba04da17bd5b27f0c3eaf9c3f71bc228bfc86b`; restart and repeat independent review pending; PostgreSQL execution remains unauthorized |
| `2026-07-17-db4-post-audit-sqlstate-path-amendment.md` | accepted amendment | Adds the persistent psql session path required for genuine native SQLSTATE capture | Incorporated into the post-audit correction implementation; no authority expansion beyond the accepted correction outcomes |
