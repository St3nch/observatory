...
| `2026-07-17-db4-r5-live-campaign-gate-preparation-authorization.md` | accepted decision | Authorizes frozen `ob-dev` compatibility review and drafting of the later owner execution gate without accepting or executing it | Live gate is `not_ready` on blockers G1–G5; `ob-dev` changes, PostgreSQL execution, DB-4 closure, DB-5, and broader work remain unauthorized |
