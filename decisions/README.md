...
| `2026-07-16-db4-r1-schema-hole-correction-authorization.md` | accepted decision | Authorizes only child-table FORCE RLS, cleanup-escape narrowing, and constrained text-key/generated-bigint reconciliation | R2–R5, profiles, fixtures, migration 010 rewiring, ob-dev, PostgreSQL execution, DB-5, and all broader work remain unauthorized |
