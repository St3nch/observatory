...
| `2026-07-17-db4-g1-g5-ob-dev-compatibility-correction-authorization.md` | accepted decision | Authorizes one exact-path cross-repo correction batch for blockers G1–G5 | PostgreSQL execution, restart before validation, live-campaign acceptance, DB-4 closure, DB-5, providers, and broader work remain unauthorized |
